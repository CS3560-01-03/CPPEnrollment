...
public class StudentRegistration extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        TableView<Object> enrolled_table = enrolledCourses.connectTable("SELECT * FROM (enrolled_info JOIN courses_enrolled) WHERE studentID = ?", student_id);//"SELECT * FROM enrolled_info WHERE studentID = ?", student_id
        ...
        dropButton.setOnMouseClicked(event -> {
            ...
            enrolledCoursesScrollPane.setContent(enrolledCourses.connectTable("SELECT * FROM enrolled_info JOIN courses_enrolled WHERE studentID IN(?)", student_id));
        });
        ...
        TableView<Object> selected_table = selectedCourses.connectTable("SELECT * FROM (cart_info JOIN cart) WHERE studentID = ?", student_id);
        ...
        removeButton.setOnMouseClicked(event -> {
            ...
            selectedCoursesScrollPane.setContent(selectedCourses.connectTable("SELECT * FROM (cart_info JOIN cart) WHERE studentID = ?", student_id));//"SELECT * FROM cart_info"
        });
        ...
        enrollButton.setOnMouseClicked(event -> {
            ...
            selectedCoursesScrollPane.setContent(selectedCourses.connectTable("SELECT * FROM (cart_info JOIN cart) WHERE studentID = ?", student_id));
        });
        ...
        enrolledCourse.setOnMouseClicked(event -> {
            enrolledCoursesScrollPane.setContent(enrolledCourses.connectTable("SELECT * FROM (enrolled_info JOIN courses_enrolled) WHERE studentID = ?", student_id));
        ...
        enrolledCourse3.setOnMouseClicked(event -> {
            enrolledCoursesScrollPane.setContent(enrolledCourses.connectTable("SELECT * FROM (enrolled_info JOIN courses_enrolled) WHERE studentID = ?", student_id));//"SELECT * FROM enrolled_info"
            primaryStage.setScene(scene2);
        });
